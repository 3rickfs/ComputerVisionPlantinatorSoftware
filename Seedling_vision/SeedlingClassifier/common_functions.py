...
class seedlingClassifier():
    ...
    def processSeedlings(self,seedlingParity,mode="offline"):
        ...
        ################################################################################################################
        chopS0 = rgbGUI[S0.enclosingBox[0][1]:S0.enclosingBox[1][1],S0.enclosingBox[0][0]:S0.enclosingBox[1][0],:]
        chopS1 = rgbGUI[S1.enclosingBox[0][1]:S1.enclosingBox[1][1],S1.enclosingBox[0][0]:S1.enclosingBox[1][0],:]
        chopS2 = rgbGUI[S2.enclosingBox[0][1]:S2.enclosingBox[1][1],S2.enclosingBox[0][0]:S2.enclosingBox[1][0],:]
        chopSeedlings = [chopS0,chopS1,chopS2]
        #################################################################################################################
